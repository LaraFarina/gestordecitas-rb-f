...
export default function FormularioComponente({
  nombreMascota, nombreDueño, fecha, hora, sintomas, error,
  setNombreMascota, setNombreDueño, setFecha, setHora, setSintomas,
  handleSubmit
}) {
  return (
